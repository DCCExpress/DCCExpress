import { AppShell, Badge, Box, Button, Card, Group, Stack, Text, ThemeIcon, Title, } from "@mantine/core";
import { IconAntennaBars5, IconMap2, IconTrain, } from "@tabler/icons-react";
export default function HomePage({ onOpenLayout }) {
