...
import { IconAntennaBars5, IconCpu, IconHome, IconMap2, IconRoute, IconSettings, IconSwitch2, IconTrain, } from "@tabler/icons-react";
export default function LeftMenu({ onGoHome, onOpenLocos }) {
    return (<Stack gap="xs">
      <NavLink label="Főoldal" leftSection={<IconHome size={16}/>} onClick={onGoHome}/>
      <NavLink label="Pálya" leftSection={<IconMap2 size={16}/>} active/>
        <NavLink label="Mozdonyok" leftSection={<IconTrain size={16}/>} onClick={onOpenLocos}/>
